...
from cogs.src.mltdevent.informations import time_cluster

async def makeimg(category: str, path: str="./cogs/dist/mltdevent/image"):
    ...
    # Configurations
    with open("./cogs/configurations/mltdevent/image_config.json") as config:
    ...
    print(f"Generating border image: {path}/{category}.png")
