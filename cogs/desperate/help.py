...
class help(Extension):
    ...
    @slash_command(name="help", description="顯示說明", scope=scopes()["all"])
    @slash_option(
        name="tag_name",
        description="欲說明的選項",
    ...
    async def help(self, ctx: SlashContext, tag_name: str):
        if tag_name == "button":
            button_demo = interactions.Button(style=interactions.ButtonStyle.PRIMARY, label="按鈕！", custom_id="button_demo")
